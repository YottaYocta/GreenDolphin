  ...
  return (
    <div className="grid grid-cols-2 grid-rows-2 gap-4 h-full rounded-xl max-md:flex-1 bg-white border border-border [box-shadow:var(--shadow-panel)] p-4">
      <button
        ...
        className={`btn-surface p-3 h-full min-h-0 cursor-pointer ${
          playState === "waiting"
      ...
      <button
        ...
        className={`btn-surface p-3 h-full min-h-0 cursor-pointer ${playState === "frozen" ? "bg-freeze hover:bg-freeze-hover active:bg-freeze-active [box-shadow:var(--shadow-btn-colored)]" : ""}`}
      >
        <SnowflakeIcon
          size={40}
          weight="fill"
